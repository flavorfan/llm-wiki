...
Use [skills](https://claude.ai/redirect/claudedotcom.v1.1365d034-cf37-46b8-8e21-5e46652d13aa/skills) to encode domain knowledge any Claude instance can load. Brendan's skills follow a "reference do not embed" principle: each skill points into a central documentation knowledgebase rather than duplicating content, keeping them lightweight and easy to maintain.
